...
flags.DEFINE_enum("agent_race", None, "protoss", "Agent's race.")
flags.DEFINE_enum("bot_race", None, "protoss", "Bot's race.")
flags.DEFINE_enum("difficulty", None, "f", "Bot's strength.")
